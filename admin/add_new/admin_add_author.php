        ...
        if(isset($_GET['add_new'])){
            if(isset($_POST['name_author'])){
                ...
                if($check_dupliacted == 0){
                    ...
                    $stmt -> execute([$_POST['name_author']]);
        ...
        <div id="content">
            <div id="top_content">
                <div id="left_content">
                    <h5>Tác giả</h5>
                    <div id="link_page">
                        <span id="header_link">Admin </span>/ Tác giả / Thêm tác giả
                    </div>
                </div>
                ...
                <div id="wrap_content">
                    <div id="top_admin_book">
                        ...
                        <?php 
                            if(isset($_GET['success'])){
                                ...
                                border-radius: 5px;
                                background-color: #f2dede;
                                padding: 10px; color: #be6455;">Đã tồn tại tên tác giả. Không thể thêm vào !</span>';
                            }
                        ?>
                        </span>
                        </h2>
                    ...
                    <div id="bottom_admin_book">
                        <form action="?add_new" method="POST">
                            ...
                            <br>
                            <input type="text" name="name_author" id="name_author" style="width:50%; height: 40px; margin-top:10px; border-radius:10px; border:1px solid #ccc;padding:10px" required>
                            <br>
